...
Shader "UserSamples/DissolveBurn"
{
	...
	SubShader
	{
		...
		void surf( Input input , inout SurfaceOutputStandard output )
		{
			...
			float temp_output_73_0 = ( (-0.6 + (( 1.0 - _DisolveAmount ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + tex2D( _DisolveGuide,input.uv_DisolveGuide).r );
...
/*ASEBEGIN
Version=3001
392;92;1247;695;1630.922;659.9638;2.5;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-919.0424,582.2975;Float;Property;_DisolveAmount;Disolve Amount;4;0;0;1
...
ASEEND*/
//CHKSM=77129F14964F49906B338AF42EE6D9428F342FE8