...
Shader "ASESampleShaders/AnimatedRefraction"
{
	...
	SubShader
	{
		...
		{
			float4 normalizedClip = ( input.screenPos/input.screenPos.w );
			float cos33 = cos( _Time.y );
			float sin33 = sin( _Time.y );
			float2 rotator33 = mul(input.uv_BrushedMetalNormal - float2( 0.5,0.5 ), float2x2(cos33,-sin33,sin33,cos33)) + float2( 0.5,0.5 );
			output.Emission = ( tex2D( _ScreenGrab0,( normalizedClip + float4( ( UnpackNormal( tex2D( _BrushedMetalNormal,rotator33) ) * _Distortion ) , 0.0 ) ).xy) * _PortalColor ).rgb;
			output.Alpha = 1;
		}
...
/*ASEBEGIN
Version=3001
393;92;1091;695;878.9791;425.8019;1.6;True;False
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-128.7738,261.0988;Float;FLOAT3;0.0,0,0;FLOAT;0.0
Node;AmplifyShaderEditor.SamplerNode;29;-542.58,195.399;Float;Property;_BrushedMetalNormal;BrushedMetalNormal;-1;None;True;0;True;bump;Auto;True;Object;-1;Auto;SAMPLER2D;0,0;FLOAT2;1.0;FLOAT;1.0;FLOAT2;0,0;FLOAT2;0,0;FLOAT;1.0
Node;AmplifyShaderEditor.RangedFloatNode;31;-437.0751,361.6983;Float;Property;_Distortion;Distortion;-1;0.292;0;1
Node;AmplifyShaderEditor.SimpleAddOpNode;30;36.62508,137.2995;Float;FLOAT4;0.0,0,0,0;FLOAT3;0.0,0,0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;704.4994,-13;Float;True;2;Float;ASEMaterialInspector;Standard;ASESampleShaders/AnimatedRefraction;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;3;False;0;0;Transparent;0.5;True;True;100;False;Transparent;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;True;FLOAT3;0,0,0;FLOAT3;0,0,0;FLOAT3;0,0,0;FLOAT;0.0;FLOAT;0.0;FLOAT;0.0;FLOAT3;0.0;FLOAT3;0.0;FLOAT;0.0;OBJECT;0.0;OBJECT;0.0;OBJECT;0,0,0;OBJECT;0.0;FLOAT3;0,0,0
...
Node;AmplifyShaderEditor.ScreenPosInputsNode;4;-428.1963,16.69999;Float;True
Node;AmplifyShaderEditor.RegisterLocalVarNode;21;-226.9862,-12.90162;Float;normalizedClip;-1;FLOAT4;0.0,0,0,0
...
ASEEND*/
//CHKSM=F4C42F3D98F3308E99790DF1CE9DB65FE897F5AD