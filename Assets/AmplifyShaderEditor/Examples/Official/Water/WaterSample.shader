...
Shader "ASESampleShaders/WaterSample"
{
	...
	SubShader
	{
		...
		void surf( Input input , inout SurfaceOutputStandardSpecular output )
		{
			...
			float temp_output_89_0 = abs( ( eyeDepth1 - input.screenPos.z ) );
...
/*ASEBEGIN
Version=3001
393;92;1091;695;756.8087;1598.884;2.800001;True;False
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1838.601,-748.1998;Half;True;2;Half;ASEMaterialInspector;StandardSpecular;ASESampleShaders/WaterSample;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;3;False;0;0;Opaque;0.5;False;False;0;True;Opaque;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;True;FLOAT3;0,0,0;FLOAT3;0,0,0;FLOAT3;0,0,0;FLOAT3;0,0,0;FLOAT;0.0;FLOAT;0.0;FLOAT3;0.0,0,0;FLOAT3;0.0,0,0;FLOAT;0.0;OBJECT;0.0;OBJECT;0.0;OBJECT;0;OBJECT;0;FLOAT3;0,0,0
...
ASEEND*/
//CHKSM=A3D4590FA8423AB95BC9C1B70A6FA2C6F190EF46