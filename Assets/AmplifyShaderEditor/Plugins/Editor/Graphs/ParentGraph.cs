...
namespace AmplifyShaderEditor
{
	...
	public class ParentGraph : ISerializationCallbackReceiver
	{
		...
		public void ResetNodesCategory()
		{
			int count = m_nodes.Count;
			for ( int i = 0; i < count; i++ )
			{
				m_nodes[ i ].ResetNodeCategory();
			}
		}
		...
		public StandardSurfaceOutputNode CurrentStandardSurface
		{
			get { return GetNode( m_masterNodeId ) as StandardSurfaceOutputNode; }
		}
