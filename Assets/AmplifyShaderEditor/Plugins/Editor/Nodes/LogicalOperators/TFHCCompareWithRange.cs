...
namespace AmplifyShaderEditor
{
	...
	public sealed class TFHCCompareWithRange : DynamicTypeNode
	{
		...
		public override string GenerateShaderForOutput( int outputId, WirePortDataType inputPortType, ref MasterNodeDataCollector dataCollector, bool ignoreLocalvar )
		{
			...
			string a = m_inputPorts[ 0 ].GenerateShaderForOutput( ref dataCollector, m_mainInputType, ignoreLocalvar, 0, true );
			string b = m_inputPorts[ 1 ].GenerateShaderForOutput( ref dataCollector, m_mainInputType, ignoreLocalvar, 0, true );
			string c = m_inputPorts[ 2 ].GenerateShaderForOutput( ref dataCollector, m_mainInputType, ignoreLocalvar, 0, true );
			string d = m_inputPorts[ 3 ].GenerateShaderForOutput( ref dataCollector, m_mainOutputType, ignoreLocalvar, 0, true );
			string e = m_inputPorts[ 4 ].GenerateShaderForOutput( ref dataCollector, m_mainOutputType, ignoreLocalvar, 0, true );
