...
namespace AmplifyShaderEditor
{
	...
	public class TFHCStub : DynamicTypeNode
	{
		...
		{
			m_inputDataPort0 = m_inputPorts[ 0 ].GenerateShaderForOutput( ref dataCollector, m_mainInputType, ignoreLocalvar, 0, true );
			m_inputDataPort1 = m_inputPorts[ 1 ].GenerateShaderForOutput( ref dataCollector, m_mainInputType, ignoreLocalvar, 0, true );
			m_inputDataPort2 = m_inputPorts[ 2 ].GenerateShaderForOutput( ref dataCollector, m_mainOutputType, ignoreLocalvar, 0, true );
			m_inputDataPort3 = m_inputPorts[ 3 ].GenerateShaderForOutput( ref dataCollector, m_mainOutputType, ignoreLocalvar, 0, true );
		}
