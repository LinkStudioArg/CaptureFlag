...
{
    [Serializable]
	[NodeAttributes("Compare (A == B)", "Logical Operators", "Check if A is equal to B. If true return value of True else return value of False", null, KeyCode.None, true, false, null, null, true )]
