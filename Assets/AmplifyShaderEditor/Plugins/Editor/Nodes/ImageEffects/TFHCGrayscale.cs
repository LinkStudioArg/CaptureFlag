...
namespace AmplifyShaderEditor
{
	...
	public sealed class TFHCGrayscale : ParentNode
	{
		...
		protected override void CommonInit( int uniqueId )
		{
			...
			AddOutputColorPorts( WirePortDataType.FLOAT, "Out" );
		...
		{
			string i = m_inputPorts[ 0 ].GenerateShaderForOutput( ref dataCollector, m_inputPorts[ 0 ].DataType, ignoreLocalvar, 0, true );
