...
namespace AmplifyShaderEditor
{
	...
	public class BlendOpsNode : ParentNode
	{
		...
		public override string GenerateShaderForOutput( int outputId, WirePortDataType inputPortType, ref MasterNodeDataCollector dataCollector, bool ignoreLocalvar )
		{
			...
			{
				src = UIUtils.CastPortType( m_currentPrecisionType, new NodeCastInfo( m_uniqueId, outputId ), null, dataType0, WirePortDataType.FLOAT4, src );
			}

			WirePortDataType dataType1 = m_inputPorts[ 1 ].ConnectionType();
			string dst = m_inputPorts[ 1 ].GenerateShaderForOutput( ref dataCollector, inputPortType, ignoreLocalvar );
			if ( dataType1 != WirePortDataType.COLOR && dataType1 != WirePortDataType.FLOAT4 )
			{
				dst = UIUtils.CastPortType( m_currentPrecisionType, new NodeCastInfo( m_uniqueId, outputId ), null, dataType1, WirePortDataType.FLOAT4, dst );
			}
