...
{
	[Serializable]
	[NodeAttributes( "Weighted Blend", "Misc", "Mix all channels through weighted sume", null, KeyCode.None, true )]
	public sealed class WeightedBlendNode : WeightedAvgNode
	{
		...
		{
			GetInputData( inputPortType, ref dataCollector, ignoreLocalvar );
