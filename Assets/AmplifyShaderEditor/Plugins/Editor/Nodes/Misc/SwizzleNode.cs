...
namespace AmplifyShaderEditor
{
    ...
    public sealed class SwizzleNode : SingleInputOp
    {
        ...
        protected override void CommonInit(int uniqueId)
        {
            ...
            m_validTypes = (int)WirePortDataType.FLOAT |
        ...
        public override string GenerateShaderForOutput(int outputId, WirePortDataType inputPortType, ref MasterNodeDataCollector dataCollector, bool ignoreLocalVar)
        {
            ...
            string inName = m_inputPorts[0].IsConnected ? InputPorts[0].GenerateShaderForOutput(ref dataCollector, inputPortType, ignoreLocalVar) : string.Empty;
