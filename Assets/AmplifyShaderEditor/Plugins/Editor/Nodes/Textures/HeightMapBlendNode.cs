...
namespace AmplifyShaderEditor
{
    ...
    public sealed class HeightMapBlendNode : ParentNode
    {
        ...
        {
            string HeightMap = m_inputPorts[0].GenerateShaderForOutput(ref dataCollector, WirePortDataType.FLOAT, false, 0, true);
            string SplatMask = m_inputPorts[1].GenerateShaderForOutput(ref dataCollector, WirePortDataType.FLOAT, false, 0, true);
            string Blend = m_inputPorts[2].GenerateShaderForOutput(ref dataCollector, WirePortDataType.FLOAT, false, 0, true);
