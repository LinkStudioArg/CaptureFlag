...
namespace AmplifyShaderEditor
{
	...
	public class UIUtils
	{
		...
		public static string CastPortType( PrecisionType nodePrecision, NodeCastInfo castInfo, object value, WirePortDataType oldType, WirePortDataType newType, string parameterName = null )
		{
			...
			string localVarName = "temp_cast_" + CurrentDataCollector.LocalVariablesAmount;//m_wirePortToCgType[ oldType ] + "To" + newTypeStr + "_" + castInfo.ToString();
